...
public class TouchData
{
   ...
   private final String DATABASE_URL = "jdbc:sqlserver://10.136.212.38;databaseName=Fitness_DB_TEM";
   // example SQL query
   private String query = "SELECT * FROM PERSON";
   // metadata of the result set (i.e. column names, etc.)
   private ResultSetMetaData metaData;
   private int [] colWdth = { 0, 8, 10, 10, 10, 12 };
   ...
   public TouchData( )
   {
      ...
      // perform the query
      try (
         Connection conn = DriverManager.getConnection( DATABASE_URL, "admin", "cmst;420" );
