...
public class SafeThreadStatesApp extends Frame implements ActionListener
{
   ...
   public void actionPerformed( ActionEvent e )
   {
      ...
      {
         counter.setMyState(RunnableCounter.RUNNING); // start counter
         thread.start( );
      ...
      {
         counter.setMyState(RunnableCounter.WAITING); // suspend counter
         pause.setEnabled( false );
         resume.setEnabled( true );
      }
      else if ( e.getSource( ) == resume )
      {
         counter.setMyState(RunnableCounter.RUNNING); // resume counter
      ...
      {
         counter.setMyState(RunnableCounter.DEAD); // stop counter
         pause.setEnabled( false );
         resume.setEnabled( false );
